...
// 0 нужен как заглушка, чтобы было удобно обращаться к переменной, типа pawn(1)=val[1]
// !!!!! Evaluator? VAL?
// попозже надо будет перенести вниз
const int Evaluator::VAL[7] = {0, 1, 3, 3, 5, 9, 20000};
